...
static const oid oid_job_history[] = {1,3,6,1,4,1,26266,86,10,1,1,3,1,0};
...
int snmp_get_jobhistory(char* ip ,char* buffer ,int bufsize)
{
    return snmp_get_oid(ip ,buffer ,bufsize ,oid_job_history ,sizeof(oid_job_history)/sizeof(oid_job_history[0]));
}
